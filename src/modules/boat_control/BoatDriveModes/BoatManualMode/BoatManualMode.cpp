...
void BoatManualMode::manual()
{
	...
	rover_throttle_setpoint.throttle_body_x = math::constrain(manual_control_setpoint.throttle, 0.f, 1.f);
...
void BoatManualMode::position()
{
	...
	const float speed_setpoint = math::interpolate<float>(math::constrain(manual_control_setpoint.throttle, 0.f, 1.f),
				     0.f, 1.f, 0.f, _param_boat_speed_lim.get());
